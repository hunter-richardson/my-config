...
#gsettings set com.ubuntu.notifications.settings use-sounds-notifications false
#gsettings set com.ubuntu.notifications.settings use-vibrations-notifications false
#gsettings set com.ubuntu.notifications.settings use-bubbles-notifications true
#gsettings set com.ubuntu.notifications.settings enable-notifications true
...
#gsettings set org.gnome.shell.extensions.apt-update-indicator check-cmd-version 'sudo apt update'
#gsettings set org.gnome.shell.extensions.apt-update-indicator interval-unit 'days'
#gsettings set org.gnome.shell.extensions.apt-update-indicator notify true
#gsettings set org.gnome.shell.extensions.apt-update-indicator output-on-terminal true
#gsettings set org.gnome.shell.extensions.apt-update-indicator strip-versions true
#gsettings set org.gnome.shell.extensions.apt-update-indicator terminal 'gnome-terminal -x fish -c'
#gsettings set org.gnome.shell.extensions.apt-update-indicator update-cmd 'sudo apt upgrade -y'
#gsettings set org.gnome.shell.extensions.apt-update-indicator update-cmd-options 'custom'
...
#gsettings set org.gnome.shell.extensions.datetime-format datemenudate-format '%A, %e %B %Y'
#gsettings set org.gnome.shell.extensions.datetime-format datemenuday-format '%A, %e %B'
#gsettings set org.gnome.shell.extensions.datetime-format statusbar-format '%A %e %B %Y, %H%M %Z'
#gsettings set org.gnome.shell.extensions.extensions position 'panel'
#gsettings set org.gnome.shell.extensions.extensions show-add true
#gsettings set org.gnome.shell.extensions.no-title-bar buttons-for-snapped true
...
#gsettings set org.gnome.shell.extensions.openweather appid-fc '5f45bf8521e04c2e702c6f5a2209adba'
#gsettings set org.gnome.shell.extensions.openweather center-forecast true
#gsettings set org.gnome.shell.extensions.openweather city '34.663253, -86.718080>Huntsville, AL>1'
...
#gsettings set org.gnome.shell.extensions.openweather refresh-interval-forecast 600
...
#gsettings set org.gnome.shell.extensions.openweather use-default-owm-key true
#gsettings set org.gnome.shell.extensions.openweather use-symbolic-icons true
...
#gsettings set org.gnome.shell.extensions.openweather wind-speed-unity 'mph'
#gsettings set org.gnome.shell.extensions.suspend-button show-two-buttons false
#gsettings set org.gnome.shell.extensions.update-extensions interval-unit 'days'
#gsettings set org.gnome.shell.extensions.update-extensions system-wide-ext true
#gsettings set org.gnome.shell.extensions.update-extensions transient true
#gsettings set org.gnome.shell.extensions.user-theme name 'Obsidian-2'
...
gsettings set org.gkt.Settings.FileChooser show-size-column true
